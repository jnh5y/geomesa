...
//    "'attr2' = '2nd100001' AND CROSSES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "'attr2' = '2nd100001' AND DISJOINT(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "'attr2' = '2nd100001' AND INTERSECTS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "'attr2' = '2nd100001' AND OVERLAPS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "'attr2' = '2nd100001' AND WITHIN(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
    "attr2 ILIKE '%1' AND CROSSES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
    //"attr2 ILIKE '%1' AND CONTAINS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
...
//    "attr2 ILIKE '1%' AND CONTAINS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "attr2 ILIKE '1%' AND INTERSECTS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "attr2 ILIKE '1%' AND OVERLAPS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
//    "attr2 ILIKE '1%' AND WITHIN(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
    "attr2 ILIKE '2nd1%' AND CROSSES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
    //"attr2 ILIKE '2nd1%' AND CONTAINS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
